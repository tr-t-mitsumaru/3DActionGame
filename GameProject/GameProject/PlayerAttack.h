...
private:
    ...
    static constexpr int    StrongAttackDamageAmount                 = 150;    // 強攻撃の与えるダメージ量
    ...
    static constexpr AttackData ComboAttackData[MaxComboCount]       = { { 0.015f ,0.2f  ,0.3f },    // コンボ攻撃に必要なデータの初期化
                                                                         { 0.04f  ,0.49f ,0.55f},
                                                                         { 0.05f  ,0.75f ,0.84f}};
